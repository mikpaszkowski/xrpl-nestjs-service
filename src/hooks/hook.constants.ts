...
export const HOOK_ON = 'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC3FFFFFDFFFFF';
// HOOK_SET | ACCOUNT_DELETE | URITOKEN_BUY | URITOKEN_CREATE_SELL_OFFER | URITOKEN_BURN | URITOKEN_CANCEL_OFFER
